 ...
 */
const MazeControlsComponent = observer(
  ({
    config,
    onConfigChange,
    onGenerate,
      ...
      <div className="bg-gray-800/50 border border-gray-700/50 rounded-lg p-4 mb-4">
        ...
        <div className="mt-4 p-3 bg-gray-700/30 rounded-lg">
          ...
          <div className="text-xs text-white/70 space-y-1">
            <p>
              <strong>Рекурсивный возврат:</strong> Классический алгоритм,
              создает лабиринты с длинными коридорами
            </p>
            <p>
            ...
            <p>
              <strong>Алгоритм Уилсона:</strong> Создает лабиринты с
              естественным, органичным видом
            </p>
          </div>
        </div>
      </div>
